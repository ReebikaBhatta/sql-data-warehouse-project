...
BEGIN
    ...
    BEGIN TRY
		...
		-- Loading silver.crm_cust_info_staging
        SET @start_time = GETDATE();
		PRINT '>> Truncating Table: silver.crm_cust_info_staging';
		TRUNCATE TABLE silver.crm_cust_info_staging;
		        PRINT '>> Inserting Data Into: silver.crm_cust_info_staging';
        INSERT INTO silver.crm_cust_info_staging (
            cst_id,
            cst_key,
            cst_firstname,
            cst_lastname,
